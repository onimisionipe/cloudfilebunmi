...
function __autoload($classname){
    if(file_exists(ROOT.DS.'controllers'.DS.  lcfirst($classname).'.php')){
        require_once ROOT.DS.'controllers'.DS.lcfirst($classname).'.php';
    }else if(file_exists(ROOT.DS.'models'.DS.  lcfirst($classname).'.php')){
        require_once ROOT.DS.'models'.DS.lcfirst($classname).'.php';
        
    }else if(file_exists(ROOT.DS.'library'.DS.  strtolower($classname).'.php')){
        require_once ROOT.DS.'library'.DS.strtolower($classname).'.php';
        
    } else if(file_exists(ROOT.DS.'services'.DS. lcfirst($classname).'.php')){
        require_once ROOT.DS.'library'.DS.lcfirst($classname).'.php';
